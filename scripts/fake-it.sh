...
time $SU nvidia-docker run --rm -v $(pwd):/images albarji/neural-style -backend cudnn -cudnn_autotune -normalize_gradients -init image -content_weight 100 -style_weight 600 -num_iterations 300 -content_image contents/$4/$1 -style_image styles/$2 -output_image $output_name -image_size $3
